        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <BlueprintCard title="Обо мне" className="h-full">
              ...
              <p className="text-blueprint-100 mb-4">
                Первоначально строил карьеру в археологии — участвовал в
                раскопках и научных проектах. Однако всё изменилось, когда мне
                предложили создать сайт для одной из компаний. Этот опыт
                вдохновил меня на переход в IT. С тех пор я последовательно
                развиваюсь в веб-разработке, проходя буткемпы, онлайн-курсы и
                реализуя проекты на практике.
              </p>
              <p className="text-blueprint-100">
                В настоящее время я работаю разработчиком в Exchange-GO, где
                участвую в создании современных веб-приложений с использованием
